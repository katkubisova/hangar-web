...
export const articles: Article[] = [
	{
		...
		body: "Placeholder body copy describing the training zone upgrade at Hangar Brno, including the new moonboard and hangboard stations now available to members.",
	...
	},
	{
		...
		body: "Placeholder body copy with five beginner-friendly tips for climbers visiting a Hangar gym for the first time.",
	...
	},
	{
		...
		body: "Placeholder body copy explaining how to read holds, sequences, and body positioning before attempting a boulder problem.",
	...
	},
	{
		...
		body: "Placeholder body copy recapping the community climbing meetup, with quotes and photos from members.",
	...
	},
	{
		...
		body: "Placeholder body copy introducing the Hangar Cafe team across locations.",
